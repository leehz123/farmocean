...
<%@ include file="/resources/jspf/body_header.jspf" %>
 ...
 <section class="section1">
	...
	<div id="naver_id_login"></div>
	<script type="text/javascript">
     var naver_id_login = new naver_id_login("tFcf6kO8bBQSvTpMwwWV", "http://54.219.31.133:80/farmocean/member/naver_callback");
     var state = naver_id_login.getUniqState();
     naver_id_login.setButton("white", 5,70);
     naver_id_login.setDomain("http://54.219.31.133:80/farmocean/member/login");
