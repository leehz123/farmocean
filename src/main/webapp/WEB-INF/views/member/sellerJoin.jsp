...
<title>구매자 회원가입</title>
   <link rel="stylesheet" href="/farmocean/resources/js/member/joinDesign.css">
    ...
    <tr>
        ...
        <td class="col2">
            <input type="password" id="post_member_pw" maxlength="15">
    ...
    <tr>
        ...
        <td class="col2">
            <input type="password" id="post_member_pw_check" maxlength="15">
    ...
    <tr>
        ...
        <td class="col2">
            <input type="text" id="post_member_nickName"
					placeholder="닉네임 입력해주세요.">
            <p>※닉네임은 <span class="num">영문+숫자 5~12자리</span>로 사용 가능합니다.</p>
    ...
    <tr>
		...
		<td class="col2">
			<input style="width: 29%; text-align: center" type="text"
				id="post_member_phoneNum1" maxlength="3"> -
			<input style="width: 29%; text-align: center" type="text"
				id="post_member_phoneNum2" maxlength="4"> -
			<input style="width: 29%; text-align: center" type="text"
				id="post_member_phoneNum3" maxlength="4"></td>
	</tr>
	<tr>
		<td class="col1"><span class="starEm">*</span>계좌번호</td>
		<td class="col2"><select id="post_member_bank" name="post_member_bank">
				<option value="신한은행">신한은행</option>
				<option value="우리은행">우리은행</option>
				<option value="국민은행">국민은행</option>
				<option value="농협">농협</option>
				<option value="우체국">우체국</option>
		</select> <input type="number" id="post_member_accountNum"
	...
	<tr>
        ...
        <td class="col2">
            ...
            <button class="but1" onclick="sample6_execDaumPostcode()" value="우편번호 찾기">우편번호 찾기</button>
        </td>
    </tr>

	<tr>
		<td class="col1"><span class="starEm">*</span>주소</td>
		<td class="col2"><input type="text" id="sample6_address" placeholder="주소"></td>
	</tr>
	<tr>
